...
var StationsConfigModule = /** @class */ (function () {
    function StationsConfigModule() {
    }
    StationsConfigModule = __decorate([
        NgModule({
            imports: [
                CommonModule,
    ...
    ], StationsConfigModule);
    return StationsConfigModule;
}());
export { StationsConfigModule };
//# sourceMappingURL=stations-config.module.js.map