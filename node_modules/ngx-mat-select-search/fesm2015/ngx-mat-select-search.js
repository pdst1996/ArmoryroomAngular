...
let MatSelectSearchComponent = MatSelectSearchComponent_1 = class MatSelectSearchComponent {
    constructor(matSelect, changeDetectorRef, _viewportRuler, matOption = null, liveAnnouncer, matFormField = null) {
        ...
        */
        ...
        this._showNoEntriesFound$ = combineLatest([
            ...
            this._options$.pipe(filter(_options => !!_options), switchMap(_options => _options.changes), map(options => options.length), startWith(this.getOptionsLengthOffset()))
    ...
    ngOnInit() {
        ...
        this._options$.pipe(filter(options => !!options), switchMap(options => options.changes), takeUntil(this._onDestroy)).subscribe(() => {
    ...
    initMultiSelectedValues() {
        ...
        ]).pipe(takeUntil(this._onDestroy)).subscribe(([value, options]) => {
