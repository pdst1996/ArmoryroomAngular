    ...
    ***************************************************************************** */
    ...
    var MatSelectSearchComponent = /** @class */ (function () {
        function MatSelectSearchComponent(matSelect, changeDetectorRef, _viewportRuler, matOption, liveAnnouncer, matFormField) {
            ...
            */
            ...
            this._showNoEntriesFound$ = rxjs.combineLatest([
                ...
                this._options$.pipe(operators.filter(function (_options) { return !!_options; }), operators.switchMap(function (_options) { return _options.changes; }), operators.map(function (options) { return options.length; }), operators.startWith(this.getOptionsLengthOffset()))
        ...
        MatSelectSearchComponent.prototype.ngOnInit = function () {
            ...
            this._options$.pipe(operators.filter(function (options) { return !!options; }), operators.switchMap(function (options) { return options.changes; }), operators.takeUntil(this._onDestroy)).subscribe(function () {
        ...
        MatSelectSearchComponent.prototype.initMultiSelectedValues = function () {
            var _this = this;
            rxjs.combineLatest([
                this._formControl.valueChanges.pipe(operators.startWith(this._formControl.value)),
                this._options$.pipe(operators.filter(function (options) { return !!options; }))
            ]).pipe(operators.takeUntil(this._onDestroy)).subscribe(function (_a) {
